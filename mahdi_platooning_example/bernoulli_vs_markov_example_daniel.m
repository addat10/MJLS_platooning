...
for i=1:length(Kp)
[MJLS,Ber]=example_ber_vs_markov_first_order_consensus_mahdi_data(TPM_path,Kp(i),T);  
...
%% helper functions
function [MJLS,Ber]=example_ber_vs_markov_first_order_consensus_mahdi_data(TPM_path,Kp,T)
